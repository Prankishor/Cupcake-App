...
class MainActivity : AppCompatActivity(R.layout.activity_main){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //In order to edit the title with changing fragments, we need the nav controller's instance that we can get from navHostFragment

        //So here we are getting the navHostFragment
